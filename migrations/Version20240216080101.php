 ...
 */
final class Version20240216080101 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commander ADD CONSTRAINT commander_ibfk_1 FOREIGN KEY (Id_Livre) REFERENCES livre (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
